...
public class SortByPriceTest {
    ...
    public void test1() {
        ...
        Item item2 = new Item(1L, "Banana", 1.0);
    ...
    public void test2() {
        // given
        Item item3 = new Item(3L, "Apple", 1.5);
        Item item2 = new Item(4L, "Banana", 2.0);
        Item item1 = new Item(5L, "Cherry", 1.0);
        Item[] itemsToSort = {item2, item1, item3};
    ...
    public void test3() {
        // given
        Item item3 = new Item(10L, "Apple", 2.0);
        Item item2 = new Item(15L, "Banana", 1.5);
        Item item1 = new Item(16L, "Cherry", 1.0);
        Item[] itemsToSort = {item2, item1, item3};
